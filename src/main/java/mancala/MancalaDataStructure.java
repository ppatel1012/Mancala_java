...
public class MancalaDataStructure implements Serializable{
    ...
    //    System.out.println("in this add stones "+pitNum);
    ...
    public int addToStore(final int playerNum, final int numToAdd) {
       ...
       return helperAddToStore(numToAdd, store);
        //store.addStones(numToAdd);
        //return store.getStoneCount();
    }
    private int helperAddToStore(final int numToAdd, final Countable store){
        store.addStones(numToAdd);
        return store.getStoneCount();
    }
    ...
    //    System.out.println("pitnm is "+pitNum);
    ...
    private void loopIterator() {
       // System.out.println("np");
        ...
        //    System.out.println("nyesp "+PLAYER_TWO);
            iteratorPos = 1;
        }
    }
    private void skipPosition() {
        while (iteratorPos == playerSkip || iteratorPos == pitSkip) {
           // System.out.println("int his skip poistion");
            iteratorPos++;
            loopIterator();
        }
    }
