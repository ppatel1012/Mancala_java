...
public class KalahRulesTest {
    ...
    public void testMoveStonesOneMove() throws InvalidMoveException {
        ...
        System.out.println("for this one");
        int num = rules.moveStones(6,1);
       // int valud = data.getNumStones(7);
        //assertEquals(5, valud);
    //    System.out.println("for this one");
    ...
    public void testMoveStonesWithCapture() throws InvalidMoveException {
        ...
        */
        ...
        System.out.println("for this one now");
        data.addStones(6,4);
      //  assertEquals(data.getNumStones(6), 8);
        //remove all stones from pit 1
        data.removeStones(1);
        assertEquals(data.getNumStones(1), 0);
        //player one move stones starting at pit one
        int num = rules.moveStones(6,1);
        System.out.println("kinda ends here");
        assertEquals(data.getNumStones(6), 0);
        assertEquals(data.getNumStones(7), 5);
